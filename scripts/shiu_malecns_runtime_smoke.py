...
from brian2 import Network, ms, start_scope
...
def main() -> int:
    ...
    p.add_argument("--run-ms", type=float, default=0.2)
    ...
    result = {
        ...
        "interpretation": (
            ...
            "pinned Shiu Brian2 reference dynamics. No game input or learning was applied."
        ),
    }
